  ...
  return (
    <section className="py-12 md:py-20 bg-background">
      <div className="container mx-auto px-4">
        {/* All-in-One Card */}
        <div className="bg-secondary rounded-2xl p-6 md:p-10 mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => (
            <div key={feature.title} className="text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl border border-border bg-card mb-4">
              ...
              <button className="text-foreground font-semibold text-sm">
                ... Read more
              </button>
            </div>
          ))}
